...
var Subscribe = function (_Component) {
  ...
  function Subscribe() {
    ...
    return _ret = (_temp = (_this3 = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this3), _this3.state = {}, _this3.instances = [], _this3.unmounted = false, _this3.onUpdate = function () {
  ...
  Subscribe.prototype._createInstances = function _createInstances(map, containers) {
    ...
    var instances = containers.map(function (ContainerItem) {
      ...
      if ((typeof ContainerItem === 'undefined' ? 'undefined' : _typeof(ContainerItem)) === 'object') {
  ...
  Subscribe.prototype.render = function render() {
    ...
    return createComponentVNode(2, StateContext.Consumer, {
...
function Provider(props) {
  return createComponentVNode(2, StateContext.Consumer, {
    children: function children(parentMap) {
      ...
      return createComponentVNode(2, StateContext.Provider, {
        'value': childMap,
